...
module CalendarDateSelect::FormHelpers
  ...
  private
    ...
    def calendar_date_select_process_options(options)
      ...
      for key in [:default_time, :time, :valid_date_check, :embedded, :buttons, :clear_button, :format, :year_range, :month_year, :popup, :hidden, :minute_interval, :popup_by, :close_on_click] + callbacks
